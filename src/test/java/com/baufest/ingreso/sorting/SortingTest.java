...
public class SortingTest {
    ...
    /**
     * Test of ordenarPorPuntuacionYNombre method, of class Sorting.
     */
    @Test
    public void testOrdenarPorPuntuacionYNombre() {
        System.out.println("ordenarPorPuntuacionYNombre");
        List<Jugador> jugadores = null;
        List<Jugador> expResult = null;
        List<Jugador> result = Sorting.ordenarPorPuntuacionYNombre(jugadores);
    ...
    /**
     * Test of ordenarPorPuntuacionPerdidasYNombre method, of class Sorting.
     */
    @Test
    public void testOrdenarPorPuntuacionPerdidasYNombre() {
        System.out.println("ordenarPorPuntuacionPerdidasYNombre");
        List<Jugador> jugadores = null;
        List<Jugador> expResult = null;
        List<Jugador> result = Sorting.ordenarPorPuntuacionPerdidasYNombre(jugadores);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
